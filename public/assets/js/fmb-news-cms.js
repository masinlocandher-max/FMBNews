(() => {
  ...
  function upgradeWorldwideShell() {
    const pathname = location.pathname.replace(/\/+$/, '/');
    if (!pathname.startsWith('/news/world/')) return;

    document.body.classList.add('fmb-worldwide-route');
    ensureStylesheet('/assets/css/fmb-worldwide.css?v=20260831-worldwide-v2', 'fmbWorldwideCms');
    ensureStylesheet('/assets/css/fmb-worldwide-v2.css?v=20260831-worldwide-v2', 'fmbWorldwideV2Cms');
