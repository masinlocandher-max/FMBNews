(()=>{
  ...
  const slogans=[
    ...
    'Facts first. Context always.',
    'Stay informed. Stay aware. Stay connected.',
  ...
  if(slogan){
    ...
    setInterval(()=>{
      ...
      setTimeout(()=>{slogan.textContent=slogans[index];slogan.classList.remove('is-changing')},180);
    },7200);
  }
