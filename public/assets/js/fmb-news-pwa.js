(()=>{
  ...
  function addStyles(){
    ...
    style.textContent=`
      .fmb-pwa-install{display:none;align-items:center;justify-content:center;gap:.45rem;border:1px solid rgba(255,255,255,.18);border-radius:999px;background:rgba(255,255,255,.09);color:#fff;padding:.72rem 1rem;font:inherit;font-weight:700;cursor:pointer;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
  ...
  function installButton(){
    ...
    const target=document.querySelector('.fmb-approved-hero-cta')||document.querySelector('.actions')||document.body;
