(()=>{
  ...
  function svg(key){
    const icons={
      ...
      home:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 10.5 12 4l8 6.5V20h-6v-6h-4v6H4z"></path></svg>',
      news:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 10.5 12 4l8 6.5V20h-6v-6h-4v6H4z"></path></svg>',
      ...
      sports:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 4h8v3c0 3-1.5 5-4 6-2.5-1-4-3-4-6zM12 13v4M8 20h8M6 6H4c0 3 1.3 5 4.2 5.7M18 6h2c0 3-1.3 5-4.2 5.7"></path></svg>',
  ...
  function openMore(opener){
    ...
    const sheet=openSheet('More from FMB News',`${accountItem}${customizeItem}${installItem}<a href="/news/archive/">News <span>›</span></a><a href="/news/world/">World <span>›</span></a><a href="/news/sports/">Sports <span>›</span></a><a href="/news/fmb-brief/">Daily Briefing <span>›</span></a><a href="/news/fact-check/">Fact Check <span>›</span></a><a href="/news/explainer/">Explainers <span>›</span></a><a href="/news/entertainment/">Entertainment <span>›</span></a><a class="fmb-menu-sub" href="/news/horoscope/">Weekly Horoscope <span>›</span></a><a class="fmb-menu-sub" href="/news/crossword/">Read Between the Headlines <span>›</span></a><a href="/news/about/">About FMB News <span>›</span></a><a href="/news/founder/">Founder <span>›</span></a><a href="/news/submit/">Submit a story <span>›</span></a>${secondaryItems}`,opener);
    const openAccount=()=>{
