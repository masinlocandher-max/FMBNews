...
assert.notEqual(darkBackground,'rgb(251, 249, 252)','Dark mode must change the page background.');
...
await browser.close();
console.log('FMB News appearance browser QA passed: System follows device preference, Light/Dark cycle correctly, persistence survives reload, and the mobile menu exposes Appearance.');
