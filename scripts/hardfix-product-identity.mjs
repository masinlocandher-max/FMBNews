...
function applyBodyClass(html,cls){
  return html.replace(/<body\s+class="([^"]*)"/i,(_m,c)=>{const set=new Set(c.split(/\s+/).filter(Boolean));['fmb-news-route','fmb-daily-brief-route','fmb-worldwide-route','fmb-network-landing'].forEach(x=>set.delete(x));set.add(cls);return `<body class="${[...set].join(' ')}"`;});
}
...
function canonicalNav(active){
  const items=[['FMB News','/news/archive/'],['FMB Worldwide','/news/world/'],['FMB Daily Brief','/news/fmb-brief/'],['About','/news/about/']];
...
function canonicalFooter(){
  return `<footer class="footer"><div class="shell footer-grid"><div><div class="footer-publication-title">Filipino Media Bulletin</div><div class="footer-publication-kicker">Information with Purpose</div><p>Verified reporting, useful context, and clear explanations for Filipino readers.</p><a href="/news/about/"><strong>About Filipino Media Bulletin →</strong></a><div class="footer-socials" aria-label="Filipino Media Bulletin social links"><a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">f</a><a href="https://x.com/" target="_blank" rel="noopener noreferrer" aria-label="X">×</a><a href="mailto:withlovefmb@gmail.com" aria-label="Email Filipino Media Bulletin">✉</a></div></div><div><h3>Publications</h3><a href="/news/archive/">FMB News</a><a href="/news/world/">FMB Worldwide</a><a href="/news/fmb-brief/">FMB Daily Brief</a></div><div><h3>Resources</h3><a href="/news/about/">About</a><a href="mailto:withlovefmb@gmail.com?subject=Story%20Submission%20for%20FMB%20News">Submit a Story</a><a href="/news/about/#standards">Corrections Policy</a><a href="/privacy/">Privacy Policy</a></div></div><div class="shell footer-bottom">© 2026 Filipino Media Bulletin. All rights reserved.</div></footer>`;
}
...
console.log(`Product identity hard fix applied to ${changed} pages: FMB News, FMB Worldwide, FMB Daily Brief; Filipino Media Bulletin footer simplified with no duplicate subscription form.`);
