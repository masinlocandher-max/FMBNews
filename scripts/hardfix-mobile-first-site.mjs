...
const mobileGlobalJs='<script src="/assets/js/fmb-news-mobile-global.js?v=20260914-editorial-shell-v2" defer></script>';
...
async function apply(target){
  ...
  html=upsertJs(html,'/assets/js/fmb-news-mobile-global.js',mobileGlobalJs,'20260914-editorial-shell-v2');
