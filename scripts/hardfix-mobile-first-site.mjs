...
const mobileGlobalJs='<script src="/assets/js/fmb-news-mobile-global.js?v=20260902-approved-shell-v1" defer></script>';
...
async function apply(target){
  ...
  html=upsertJs(html,'/assets/js/fmb-news-mobile-global.js',mobileGlobalJs,'20260902-approved-shell-v1');
