...
const mobileProductHeroesCss='<link rel="stylesheet" href="/assets/css/fmb-news-mobile-product-heroes.css?v=20260902-product-heroes-v3">';
const mobileMenuHolderCss='<link rel="stylesheet" href="/assets/css/fmb-news-mobile-menu-holder.css?v=20260902-menu-holder-v1">';
...
async function apply(target){
  ...
  html=upsertCss(html,'/assets/css/fmb-news-mobile-product-heroes.css',mobileProductHeroesCss,'20260902-product-heroes-v3');
  html=upsertCss(html,'/assets/css/fmb-news-mobile-menu-holder.css',mobileMenuHolderCss,'20260902-menu-holder-v1');
  ...
  html=upsertJs(html,'/assets/js/fmb-news-mobile-home.js',mobileHomeJs,'20260902-app-home-v2');
...
console.log('Applied the unified Filipino Media Bulletin mobile system with one masthead, one premium dark product menu holder, proportional full-bleed Home hero, strict shared Worldwide/Explainer/Daily Brief hero geometry, final contrast lock, immediate internal product content, and no legacy duplicate navigation.');
