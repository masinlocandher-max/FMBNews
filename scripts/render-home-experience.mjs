...
function renderMobileHome(stories) {
  ...
  <div class="fmb-mobile-live-strip">
    <span class="fmb-mobile-live-clock" aria-label="Philippine Standard Time"><strong data-fmb-local-date>Today</strong><span data-fmb-local-time>--:--</span></span>
  </div>
...
function applyDesktopPublicationLanding(html, stories) {
  ...
  html = html.replace(/<meta property="og:description" content="[^"]*">/i, '<meta property="og:description" content="Verified reporting, visible sources, meaningful context.">');
  ...
  const mast = `<header class="mast publication-mast"><div class="publication-header-inner"><div class="publication-brand-row"><div class="publication-date-block"><span data-pht-date>Philippine Standard Time</span><br><span data-pht-clock>--:--</span></div><a class="publication-lockup" href="/news/" aria-label="Filipino Media Bulletin"><img class="publication-emblem" src="/assets/images/brand/fmb-bulletin-emblem.svg" alt=""><span class="fmb-editorial-wordmark">FMB NEWS<span class="dot">.</span></span><span class="fmb-editorial-subtitle">Filipino Media Bulletin</span><span class="publication-name"><strong class="publication-wordmark">Filipino Media Bulletin</strong></span></a><div class="publication-purpose">francinemariebautista.com<br>/news</div></div><nav class="nav publication-nav" aria-label="Filipino Media Bulletin"><a href="/news/">Home</a><a href="/news/archive/">News</a><a href="/news/world/">Worldwide</a><a href="/news/sports/">Sports</a><a href="/news/fmb-brief/">Daily Brief</a><a href="/news/fact-check/">Fact Check</a><a href="/news/explainer/">Explainer</a><details class="publication-menu"><summary>Entertainment</summary><div class="publication-menu-panel"><a href="/news/horoscope/">Weekly Horoscope</a><a href="/news/crossword/">Read Between the Headlines</a></div></details><a href="/news/about/">About</a><a class="publication-search" href="/news/search/" aria-label="Search FMB News">${searchIcon}</a></nav></div></header>`;
