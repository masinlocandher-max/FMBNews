...
console.log(`Rendered canonical FMB News home experience in one pass: desktop Filipino Media Bulletin landing plus mobile app home with ${stories.slice(0, 5).length} latest stories.`);
