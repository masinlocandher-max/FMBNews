...
function canonicalFooter(){
  return `<footer class="footer fmb-news-footer"><div class="shell footer-grid fmb-news-footer-grid"><div class="fmb-news-footer-brand"><a class="fmb-news-footer-lockup" href="/news/" aria-label="Filipino Media Bulletin"><img class="fmb-news-footer-emblem" src="/assets/images/brand/fmb-bulletin-emblem.svg" alt="" width="48" height="48" loading="lazy" decoding="async"><div><div class="footer-publication-title">Filipino Media Bulletin</div><div class="footer-publication-kicker">Information with Purpose</div></div></a><p class="fmb-news-footer-copy">Verified facts, visible sources, meaningful context, and clear explanations for Filipino readers.</p></div><nav aria-label="FMB publications"><h3>Publications</h3><a href="/news/archive/">FMB News</a><a href="/news/world/">FMB Worldwide</a><a href="/news/explainer/">FMB Explainer</a><a href="/news/fact-check/">FMB Fact Check</a><a href="/news/fmb-brief/">FMB Daily Brief</a></nav><nav aria-label="FMB newsroom resources"><h3>Newsroom</h3><a href="/news/about/">About</a><a href="/news/search/">Search</a><a href="/news/submit/">Submit a Story</a><a href="/news/about/#standards">Corrections</a><a href="/news/feed.xml">RSS Feed</a></nav></div><div class="shell footer-bottom"><span>© 2026 Filipino Media Bulletin. All rights reserved.</span><span>FMB News · Philippines</span></div></footer>`;
}
...
console.log(`Unified FMB News footer across ${changed} pages: one Filipino Media Bulletin lockup, all five editorial products, newsroom utilities, RSS access, no fake social destinations, and no duplicate footer forms.`);
