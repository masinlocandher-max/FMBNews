...
console.log('Canonical FMB News network shell verification passed: one renderer owns shared publication chrome, all five products are present, the homepage landing contract is preserved, and superseded shell hardfixes are absent from the build path.');
