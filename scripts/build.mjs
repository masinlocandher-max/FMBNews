...
// Run ticker normalization after the audit because search/submit utility pages
// are generated by that audit pass and must receive the same one-clock network bar.
